...
(You should also set a user agent with contact information as required by Wikipedia's API guidelines, otherwise these requests may fail due to rate limiting of the default user agent set by the library.)
